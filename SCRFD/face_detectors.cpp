...
int main(){
    ...
    cv::Mat img = cv::imread("../test_images/test5.jpg");
    cv::cvtColor(img, img, cv::COLOR_BGR2RGB);
    cv::Mat img2 = cv::imread("../test_images/test6.jpg");
    cv::cvtColor(img2, img2, cv::COLOR_BGR2RGB);
    cv::Mat img3 = cv::imread("../test_images/test7.jpg");
    cv::cvtColor(img3, img3, cv::COLOR_BGR2RGB);
    cv::Mat img4 = cv::imread("../test_images/test8.jpg");
    cv::cvtColor(img4, img4, cv::COLOR_BGR2RGB);
    lst_rgb_image.push_back(img);
